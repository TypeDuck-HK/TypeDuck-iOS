...
class PadShortKeyboardViewLayout : KeyboardViewLayout {
    ...
    static let letters: [[[KeyCap]]] = [
        ...
        [[.nextKeyboard, .keyboardType(.numeric), .toggleInputMode(.english, nil)], [.space(.space)], [.keyboardType(.numeric), .dismissKeyboard]]
    ]
    ...
    static let numbersHalf: [[[KeyCap]]] = [
        ...
        [[.nextKeyboard, .keyboardType(.alphabetic(.lowercased)), .toggleInputMode(.english, nil)], [.space(.space)], [.keyboardType(.alphabetic(.lowercased)), .dismissKeyboard]]
    ]
