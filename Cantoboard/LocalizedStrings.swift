...
class LocalizedStrings {
    ...
    static let candidateFontSize_small = localizedString("inputMethodSettings.candidateFontSize.small")
    ...
    static let candidateGap = localizedString("inputMethodSettings.candidateGap")
    static let candidateGap_normal = localizedString("inputMethodSettings.candidateGap.normal")
    static let candidateGap_large = localizedString("inputMethodSettings.candidateGap.large")
    ...
    static let showCodeInReverseLookup = localizedString("chineseInputSettings.showCodeInReverseLookup")
    ...
    static let cantoneseKeyboardLayout = localizedString("chineseInputSettings.cantoneseKeyboardLayout")
    static let cantoneseKeyboardLayout_qwerty = localizedString("chineseInputSettings.cantoneseKeyboardLayout.qwerty")
    static let cantoneseKeyboardLayout_tenKeys = localizedString("chineseInputSettings.cantoneseKeyboardLayout.tenKeys")
    ...
    static let about_links = localizedString("about.links")
