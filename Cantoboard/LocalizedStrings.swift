...
class LocalizedStrings {
    ...
    static let languageDisplaySettings = localizedString("languageDisplaySettings")
    static let languageDisplaySettings_eng = localizedString("languageDisplaySettings.eng")
    static let languageDisplaySettings_hin = localizedString("languageDisplaySettings.hin")
    static let languageDisplaySettings_ind = localizedString("languageDisplaySettings.ind")
    static let languageDisplaySettings_nep = localizedString("languageDisplaySettings.nep")
    static let languageDisplaySettings_urd = localizedString("languageDisplaySettings.urd")
    static let mainLanguage = localizedString("languageDisplaySettings.mainLanguage")
    static let mainLanguage_eng = localizedString("languageDisplaySettings.mainLanguage.eng")
    static let mainLanguage_hin = localizedString("languageDisplaySettings.mainLanguage.hin")
    static let mainLanguage_ind = localizedString("languageDisplaySettings.mainLanguage.ind")
    static let mainLanguage_nep = localizedString("languageDisplaySettings.mainLanguage.nep")
    static let mainLanguage_urd = localizedString("languageDisplaySettings.mainLanguage.urd")
